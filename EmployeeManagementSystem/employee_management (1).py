...
class EmployeeManagementSystem:
    def __init__(self, master):
        ...
        self.master = master
        self.master.title("Employee Management System | Developed by Aparna and team")
        ...
        background_image = Image.open("EmployeeManagementSystem/1.jpg")
        ...
        # Open the image
        icon_image = Image.open("EmployeeManagementSystem/logo1.png.jpg")
        desired_width = 80  
        desired_height = 80  
        ...
        menu=Label(leftmenu,text="Menu",height=3, font=("Helvetica",25),bg="#009688").pack(side=tk.TOP,fill=tk.X)
        ...
        self.add_button = tk.Button(leftmenu, text="Add Employee", command=self.add_employee, bg="#4CAF50",fg="white", font=("Helvetica", 14), height=3)
        self.add_button.pack(fill="x", padx=10, pady=5)

        self.view_button = tk.Button(leftmenu, text="View Employees", command=self.view_employees, bg="#008CBA", fg="white", font=("Helvetica", 14), height=3)
        self.view_button.pack(fill="x", padx=10, pady=5)

        self.update_button = tk.Button(leftmenu, text="Update Employee", command=self.update_employee, bg="#f44336", fg="white", font=("Helvetica", 14), height=3)
        self.update_button.pack(fill="x", padx=10, pady=5)

        self.delete_button = tk.Button(leftmenu, text="Delete Employee", command=self.delete_employee, bg="#FF9800", fg="white", font=("Helvetica", 14), height=3)
        self.delete_button.pack(fill="x", padx=10, pady=5)

        self.find_button = tk.Button(leftmenu, text="Find Employees", command=self.find_employees_by_position, bg="#FFC107", fg="white", font=("Helvetica", 14), height=3)
        self.find_button.pack(fill="x", padx=10, pady=5)

        self.quit_button = tk.Button(leftmenu, text="Quit", command=self.master.quit, bg="#555", fg="white", font=("Helvetica", 14), height=3)
